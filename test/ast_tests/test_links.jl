...
anchor_tests = [
(input="[heading 1 anchor]\n\n[heading 1 anchor]{* Heading 1}", target=AST.DetachedModifierLocation("Heading 1", 1))
(input="[heading 2 anchor]\n\n[heading 2 anchor]{** Heading 2}", target=AST.DetachedModifierLocation("Heading 2", 2))
(input="[heading 3 anchor]\n\n[heading 3 anchor]{*** Heading 3}", target=AST.DetachedModifierLocation("Heading 3", 3))
(input="[heading 4 anchor]\n\n[heading 4 anchor]{**** Heading 4}", target=AST.DetachedModifierLocation("Heading 4", 4))
(input="[heading 5 anchor]\n\n[heading 5 anchor]{***** Heading 5}", target=AST.DetachedModifierLocation("Heading 5", 5))
(input="[heading 6 anchor]\n\n[heading 6 anchor]{****** Heading 6}", target=AST.DetachedModifierLocation("Heading 6", 6))
(input="[heading 7 anchor]\n\n[heading 7 anchor]{******* Heading 7}", target=AST.DetachedModifierLocation("Heading 7", 7))
(input="[generic anchor]\n\n[generic anchor]{# Generic}", target=AST.MagicLocation("Generic"))
(input="[norg file anchor]\n\n[norg file anchor]{:norg_file:}", target=AST.FileLocation(false, "norg_file", nothing))
(input="[external heading 1 anchor]\n\n[external heading 1 anchor]{:norg_file:* Heading 1}", target=AST.FileLocation(false, "norg_file", nothing), subtarget=AST.DetachedModifierLocation("Heading 1", 1))
(input="[external heading 2 anchor]\n\n[external heading 2 anchor]{:norg_file:** Heading 2}", target=AST.FileLocation(false, "norg_file", nothing), subtarget=AST.DetachedModifierLocation("Heading 2", 2))
(input="[external heading 3 anchor]\n\n[external heading 3 anchor]{:norg_file:*** Heading 3}", target=AST.FileLocation(false, "norg_file", nothing), subtarget=AST.DetachedModifierLocation("Heading 3", 3))
(input="[external heading 4 anchor]\n\n[external heading 4 anchor]{:norg_file:**** Heading 4}", target=AST.FileLocation(false, "norg_file", nothing), subtarget=AST.DetachedModifierLocation("Heading 4", 4))
(input="[external heading 5 anchor]\n\n[external heading 5 anchor]{:norg_file:***** Heading 5}", target=AST.FileLocation(false, "norg_file", nothing), subtarget=AST.DetachedModifierLocation("Heading 5", 5))
(input="[external heading 7 anchor]\n\n[external heading 6 anchor]{:norg_file:****** Heading 6}", target=AST.FileLocation(false, "norg_file", nothing), subtarget=AST.DetachedModifierLocation("Heading 6", 6))
(input="[external generic anchor]\n\n[external generic anchor]{:norg_file:# Generic}", target=AST.FileLocation(false, "norg_file", nothing), subtarget=AST.MagicLocation("Generic"))
(input="[non-norg file anchor]\n\n[non-norg file anchor]{/ external_file.txt}", target=AST.FileLinkableLocation(false, "external_file.txt", nothing))
(input="[url anchor]\n\n[url anchor]{https://github.com/}", target=AST.URLLocation("https://github.com/"))
(input="[file anchor]\n\n[file anchor]{file:///dev/null}", target=AST.URLLocation("file:///dev/null"))
]
